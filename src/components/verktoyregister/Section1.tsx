        ...
        <MarginLayout>
          <div className="content-margins">
            <div id="access">
              ...
              <p className="mb">
                Jeg forsøkte å lage et system i Microsoft Excel, men jeg ville
                ha noe som kunne minne mer om en app der man kan klikke seg inn
                på forskjellige blader. Så jeg begynte å utvikle et system i
                Microsoft Access. Der kunne vi legge inn registreringsdato,
                hvilke datoer som de ble omloddet på og da hadde vi også telling
                på hvor mange ganger de har blitt omloddet. Man kunne legg inn
                en kommentar. Og vi kunne legge inn hvor mange stokker som
                sagbladet har saget. Senere så fjernet jeg stokkantall på
                bladene da dette var mye jobb å få lagt inn korrekt og at dataen
                på dette var meningsløse og ikke ble brukt til noe. Mars 2016
                begynner vi med å legge inn bladene våre i Access databasen. Det
                var heller ikke noe lettvint å bruke dataen til statistikk. Jeg
                lagde et opplegg der vi kunne se hvor mange blad som ble vraket
                eller lagt til. Men hver gang vi vraket et blad så måtte vi
                ...
                antall omloddinger, for det måtte vi ha. Og statistikken ble
                skrotet.
              </p>
              <Image
                layout="responsive"
            ...
            <div id="webapplikasjon">
              ...
              <p className="mbl">
                ...
                nye databasen manuelt. Jeg bruker MongoDB og å logge seg på der
                å legge inn data er meget tungvint så jeg designet et lite
                program for å gjøre overføringen lettere. Med all data på plass
                så blir Microsoft access skrotet og vi går over til den nye
                sagbladregisteret.
              </p>
              <Column2Layout>
                <p>
                  ...
                  trenger ikke alltid og gå til datamaskinen for å gjøre det.
                  Men appen føles treg og man må åpne en helt ny side bare for å
                  f.eks slette et blad. Dette fordi jeg har begrenset kunnskap
                  om backend programmering. Så denne applikasjonen blir ikke den
            ...
            <div id="mobil">
              ...
              <p className="mb">
                Jeg har også drevet litt med React Native der man kan lage
                Native apper til mobil og legge ut på App store eller Google
                play. Jeg lagde sagbladregister også med React Native. Native
                appen blir aldri lagt ut på Google Play eller App Store, men jeg
                får brukt den på min egen mobil. På backend siden legger jeg inn
                ...
                gjorde på Access appen. Mobil appen og webapplikasjonen er
            ...
            <div id="oppgradering">
              ...
              <Column2Layout>
                <p>
                  ...
                  å filtrere ut data som skal vises.
                </p>
                <img
                  className="img"
            ...
            <div id="sagbladoversikt">
              ...
              <div>
                <p>
                  ...
                  flere ganger at leveringstiden kan bli flere måneder lenger en
                  antatt. Dette gjør det vanskelig å vite når man bør bestille
                  blader. Noen ganger har vi nesten gått tom for noen bladtyper
                  fordi levering var forsinket.
                </p>
                <br />
                <p className="mb">
                  Løsningen på det ble at leverandør holder lager av bladene som
                  vi trenger. De bestiller opp nye når vi henter ut. Men sånn
                  som det er idag så forbruker vi blader til det begynner å bli
                  lite og så henter vi ut fra lageret hos leverandør. Forbruket
                  er forskjellig fra år til år og det er stor forskjell fra
                  milde og kalde vintre. Det kan være litt vanskelig å vite hvor
                  mye man bør ha på lager.
                </p>
              </div>
              <img
                className="img"
              ...
              <div>
                ...
                />
                <p>
                  Sagbladregisteret kan hjelpe oss med å ha litt mer kontroll
                  hvor stort lager vi bør ha. Jeg har utviklet en applikasjon
                  til leverandør som er denne appen her. Her er det oversikt
                  over. Vi har sending hver 14 dag og det har vært snakk om å
                  erstatte vrakede blade med nye i så korte intervaller hvis det
                  er snakk om mye.
                </p>
                <br />
                <p>
                  ...
                  leverandør selv kan velge hvilken tidsperiode de vil hente
            ...
            <div id="verktoyregister">
              ...
              <Column2Layout>
                <div>
                  <p>
                    ...
                    nummer. Men Det er også flere bladtyper som ikke omloddes,
                    men brukes kun til de er utslitt og kastes. Det er også en
                    del annet verktøy som kniver og segmenter. Ikke noe av dette
                  ...
                  <p>
                    ...
                    forøvrig verktøy så blir det annerledes da det ikke trenger
                    å ha egne id nummere men registrers i antall. Da blir det et
                    helt annet system enn sagbladregister, der hver type verktøy
                    må oppdateres med antall til eller fra. Man sletter altså
                    ikke noe fra databasen sånn som man gjør i sagbladregister.
                    Det ender med at jeg begynner å lage en ny app.
                  </p>
                </div>
                <div>
                  <img
              ...
              />
              <p className="img-text">
                På bildet over kan man søke etter bladene som har egen id
                nummer. Der man kan legge til en omlodding, kommentar eller
                slette bladet. Bladene som slettes eller lagt til en omlodding
                blir satt i listen til venstre. De sorteres etter måneder og man
                kan klikke på rød pil for å gå måneder tilbake å se hvilke
                blader som ble vraket eller omloddet i den aktuelle måneden.
              </p>
            </div>
            <div id="verktoyregister2">
              <h1 className="header mb mtl">Verktøyregister 2</h1>
              <p className="mb">
                Jeg begynner enda en gang med verktøyregister. Denne gangen er
                det et helt nytt design med menyer på venstre side på appen. Jeg
                var ikke helt fornøyd med den forrige appen da den kan virke noe
                mer uoversiktlig. Så jeg prøver meg enda en gang med en ny app.
              </p>
              <img
                className="img mb"
